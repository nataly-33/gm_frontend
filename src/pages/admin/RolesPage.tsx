export default function RolesPage() {
  const ROLES = [
    { id: 1, name: 'admin', description: 'Acceso total al panel de administración. Asignado manualmente desde el backend.', is_system: true },
    { id: 2, name: 'user',  description: 'Usuario estándar. Se asigna automáticamente al registrarse.', is_system: true },
  ]
  ...
  return (
    <div className="p-6 text-white">
      ...
      <p className="text-muted text-sm mb-6">
        Los roles son gestionados desde el backend y asignados por el seeder o manualmente.
        No es necesario crearlos desde el panel.
      </p>
