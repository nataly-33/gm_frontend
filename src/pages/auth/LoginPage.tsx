...
export default function LoginPage() {
  ...
  async function handleSubmit(e: FormEvent) {
    ...
    try {
      ...
      const destination = data.usuario.roles?.includes('admin') ? '/admin' : '/'
    ...
    <>
      ...
      >
        <div className="w-full max-w-[260px] flex flex-col items-center text-center">
          ...
          <form onSubmit={handleSubmit} className="w-full flex flex-col gap-3 text-left">
            <div className="flex flex-col gap-1">
              ...
              <input
                ...
                className="login-input w-full rounded-[4px] px-3 py-2.5 text-xs outline-none"
            ...
            <div className="flex flex-col gap-1">
              ...
              <div className="relative">
                <input
                  ...
                  className="login-input w-full rounded-[4px] px-3 py-2.5 text-xs outline-none pr-10"
                  style={{ border: '1px solid #727272', transition: 'border-color 0.15s' }}
                  onFocus={e => (e.currentTarget.style.borderColor = '#fff')}
                  onBlur={e => (e.currentTarget.style.borderColor = '#727272')}
                />
                ...
                >
                  {showPassword ? (
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                      ...
                      <path d="M3.35 5.47q-.27.24-.518.487A13 13 0 0 0 1.172 8l.195.288c.335.48.83 1.12 1.465 1.755C4.121 11.332 5.881 12.5 8 12.5c.716 0 1.39-.133 2.02-.36l.77.772A7 11 0 0 1 8 13.5C3 13.5 0 8 0 8s.939-1.721 2.641-3.238l.708.709zm10.296 8.884-12-12 .708-.708 12 12z"/>
                    </svg>
                  )}
                </button>
              </div>
          ...
          <div className="w-full flex items-center gap-2 mt-4 mb-12">
            <div className="flex-1 h-px" style={{ background: '#000000' }} />
            <span className="text-sm" style={{ color: '#a7a7a7' }}>o</span>
            <div className="flex-1 h-px" style={{ background: '#000000' }} />
          </div>
          <div className="flex flex-col items-center gap-2">
            <p className="text-xs" style={{ color: '#a7a7a7' }}>¿No tienes cuenta?</p>
            <Link to="/register" className="font-bold text-xs text-white transition-transform duration-150 inline-block hover:scale-105">
              Regístrate
            </Link>
          </div>
        </div>
