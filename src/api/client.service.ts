...
export const clientService = {
  ...
  savePaymentMethod: (paymentMethodId: string) =>
    client.post<PaymentMethod>(ENDPOINTS.credits.paymentMethods, {
  ...
  makePayment: (paymentMethodId: string, amount: number, planSlug: string, currency = 'usd') =>
    client.post<Payment>(ENDPOINTS.credits.pay, {
      payment_method_id: paymentMethodId,
      amount,
      plan_slug: planSlug,
      currency,
  ...
  getPayments: () =>
    client.get<Payment[]>(ENDPOINTS.credits.pay).then(r => r.data),
}
